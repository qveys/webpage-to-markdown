(function () {
  ...
  var translations = {
    fr: {
      ...
      'single.success': 'Page convertie',
      'single.error': 'Échec de la conversion',
      'single.reconvert': 'Reconvertir',
      'single.copy': 'Copier',
      'single.download': 'Télécharger',
    ...
    en: {
      ...
      'single.success': 'Page converted',
      'single.error': 'Conversion failed',
      'single.reconvert': 'Reconvert',
      'single.copy': 'Copy',
