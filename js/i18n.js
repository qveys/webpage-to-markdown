(function () {
  ...
  var translations = {
    fr: {
      ...
      'error.permission': 'Autorisez l’accès à ce site pour démarrer le crawl.',
      ...
      'error.permission.title': 'Autorisation requise',
      'error.permission.message': 'Autorisez l’accès à ce site pour démarrer le crawl.',
      ...
      'settings.maxAssetSize': 'Taille maximale par image (Mio)',
      'settings.maxSessionAssetSize': 'Taille maximale des images par session (Mio)',
      ...
      'debug.log.asset': 'image',
      'debug.log.skip': 'ignoré',
      'debug.log.blocked': 'bloqué',
      'debug.log.warn': 'alerte',
      'debug.log.error': 'erreur',
    ...
    en: {
      ...
      'error.permission': 'Allow access to this site to start the crawl.',
      ...
      'error.permission.title': 'Permission required',
      'error.permission.message': 'Allow access to this site to start the crawl.',
      'error.retry': 'Retry',
      'error.back': 'Back',
      ...
      'settings.theme.midnightBlue': 'Midnight Blue',
      'settings.theme.synthwave': 'Synthwave',
      ...
      'settings.theme.nord': 'Nord',
      'settings.theme.vercel': 'Vercel',
      'settings.theme.retroTerminal': 'Retro Terminal',
      ...
      'settings.maxAssetSize': 'Maximum size per image (MiB)',
      'settings.maxSessionAssetSize': 'Maximum image size per session (MiB)',
      'settings.crawl': 'CRAWL',
